...
let user={firstName:sessionStorage.getItem('firstName'),lastName:sessionStorage.getItem('latName'),idNumber:sessionStorage.getItem('idNumber'),
dataOfBirth:sessionStorage.getItem('dateOfBirth'),gender:sessionStorage.getItem('gender'),HMO:sessionStorage.getItem('HMO'),numOfChildren:sessionStorage.getItem('numOfChildren')
}
const children=[]
